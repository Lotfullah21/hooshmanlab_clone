...
SECRET_KEY = 'django-insecure-ekdhly9xd(!47_xhr@xn2c@pi&cepu_+76uul$h*w915mu*ni6'
...
ROOT_URLCONF = 'hooshmandlab_clone.urls'
...
WSGI_APPLICATION = 'hooshmandlab_clone.wsgi.application'
